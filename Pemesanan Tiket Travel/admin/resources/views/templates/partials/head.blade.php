<head>
    ...
    <!-- For iPhone -->
    <link rel="apple-touch-icon-precomposed" href="{{ asset('public/assets/images/apple-touch-icon-57-precomposed.png')}}">
    <!-- For iPhone 4 Retina display -->
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{ asset('public/assets/images/apple-touch-icon-114-precomposed.png')}}">
    <!-- For iPad -->
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{ asset('public/assets/images/apple-touch-icon-72-precomposed.png')}}">
    <!-- For iPad Retina display -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ asset('public/assets/images/apple-touch-icon-144-precomposed.png')}}">
    ...
    <link href="{{ asset('public/assets/fonts/webfont/cryptocoins.css')}}" rel="stylesheet" type="text/css" />
